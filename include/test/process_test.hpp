...
private:
     ...
     */
    static bool test_process_creation_termination();
    
    /**
     * @brief Test priority-based scheduling
     * @return true if successful
     */
    static bool test_priority_scheduling();
    
    /**
     * @brief Test sleep queue functionality
     * @return true if successful
     */
    static bool test_sleep_queue();
    
    /**
     * @brief Test aging mechanism
     * @return true if successful
     */
    static bool test_aging_mechanism();
    
    /**
     * @brief Test process blocking and waking
     * @return true if successful
     */
    static bool test_process_blocking_waking();
    
    /**
     * @brief Test priority management
     * @return true if successful
     */
    static bool test_priority_management();
    
    /**
     * @brief Test scheduler statistics and display
     * @return true if successful
     */
    static bool test_scheduler_statistics();
     ...
     */
    static u32 create_test_process(const char* name, u32 priority);
    
    /**
     * @brief Helper function to simulate scheduler ticks
     * @param ticks Number of ticks to simulate
     */
    static void simulate_scheduler_ticks(u32 ticks);
     ...
     */
    static bool verify_process_state(u32 pid, kira::system::ProcessState expectedState);
     ...
     */
    static bool verify_process_priority(u32 pid, u32 expectedPriority);
    
    /**
     * @brief Clean up all test processes
     */
    static void cleanup_all_test_processes();
};
